...
def parse_args():
	...
	parser.add_argument(
		"--module_name",
		type=str,
		choices=["offline.train_offline_agent", "online.trainer", "offline.single_level_train_offline_agent", "offline.train_multiple_offline_agents"],
...
def xpid_from_params(p, prefix="", algo="", is_single=False):
	...
	elif algo == "bc_n" or "value_distil":
