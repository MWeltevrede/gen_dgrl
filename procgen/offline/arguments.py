...
parser.add_argument("--agent_model", type=str, default="dqn", choices=["dqn", "bcq", "pporesnetbase", "pporesnet20", "bcqresnetbase", "illustrative", "illustrative_ensemble", "bcq_illustrative"], help="Agent model")
...
parser.add_argument("--policy_extraction_pessimism_coef", type=float, default=1, help="Coefficient for the pessimism auxiliarry loss")