...
from offline.agents.iql import IQL, IQLGreedy, IQLConcistency, IQLEnsemble
...
def _create_agent(args, env, extra_config):
    ...
    if agent_name == "bcq":
        ...
        return IQLGreedy(env.observation_space, 
                   ...
                   perform_polyak_update=args.perform_polyak_update,
                   initialisation=args.init)
    elif agent_name == "iql_concistency":
        return IQLConcistency(env.observation_space, 
                   env.action_space.n, 
                   args.lr, 
                   args.agent_model, 
                   args.hidden_size,
                   ...
                   perform_polyak_update=args.perform_polyak_update,
                   initialisation=args.init,
                   concistency_coef=args.iql_concistency)
