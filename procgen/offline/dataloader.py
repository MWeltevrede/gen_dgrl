...
class OfflineDataset(torch.utils.data.Dataset):
	...
	def __init__(
		...
		capacity_type: str = 'transitions', specific_level_seed: Optional[int] = None, max_episodes: Optional[int] = None, base_states: Optional[bool] = False,
	) -> None:
	...
	def __getitem__(self, index):
		...
		if self.base_states:
			base_states = curr[DatasetItemType.BASE_STATES.value][offset_in_episode]
			return (obs, actions, rewards, next_obs, dones, base_states)
		else:
